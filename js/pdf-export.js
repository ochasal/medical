...
function generatePDF(htmlContent, filename) {
  ...
  printWindow.document.write('body { font-family: Arial, sans-serif; padding: 2rem; color: #333; }');
  ...
  printWindow.document.write('@media print { body { padding: 0; margin: 0; } @page { margin: 2cm; size: letter; } }');
